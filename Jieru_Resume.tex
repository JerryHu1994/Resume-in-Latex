...
\section{Experience}
	\sectionStart
		...
		{Microsoft Corporation - Azure Compute}{April 2019 - Now}
			\experienceItemStart			
				\experienceItem
				{Developed micro-services in C\# including FrontEnd, PoolManager, DeploymentManager, as core backend of Azure Batch which handles resource allocation with deployment management, and orchestrates virtual machines for computation jobs}
				\experienceItem
				{Implemented full-stack features on Batch Diagnostic Portal which provides quicker and easier diagnostic for Batch Service using React, TypeScript and Kusto Query}
				\experienceItem
				{Set up Geneva Monitoring, Flow Reports, PowerBI dashboards using Kusto Query to keep track of both real-time and long-term Batch Service health monitoring}
			\experienceItemEnd
		\experienceHeader
